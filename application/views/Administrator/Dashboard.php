...
$(function () {
    $('#Global_Comparison_Between_Realization_and_Activity').highcharts({
        chart: {
        ...
        title: {
            text: 'Global Comparison Between Realization and Activity'
        },
        tooltip: {
...
$(function () {
    $('#Global_Comparison_Between_System_WSS_and_Daily_Report').highcharts({
        chart: {
            plotBackgroundColor: null,
            plotBorderWidth: null,
            plotShadow: false
        ...
        title: {
            text: 'Global Comparison Between System WSS and Daily Report'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <?php $this->load->view('Administrator/templete/sidebar'); ?>

            <div id="page-content-wrapper">

                <?php $this->load->view('Administrator/templete/header'); ?>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6" style="padding-top: 50px">
                                <div class="card" style="border: none;">
                                 ...
                                 <div id="Global_Comparison_Between_Realization_and_Activity"></div>
                                 </div>
                                </div>
                              </div>
                              ...
                              <div class="col-md-6" style="padding-top: 50px">
                                <div class="card" style="border: none;">
                                  <div class="card-body" style="background-color: #39c0cc1a;">
                                 <div id="Global_Comparison_Between_System_WSS_and_Daily_Report"></div>
                                 </div>
                                </div>
                              </div>
